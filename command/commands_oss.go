...
import (
	...
	aclagent "github.com/opengyoza/opengyoza/command/acl/agenttokens"
	aclam "github.com/opengyoza/opengyoza/command/acl/authmethod"
	aclamcreate "github.com/opengyoza/opengyoza/command/acl/authmethod/create"
	aclamdelete "github.com/opengyoza/opengyoza/command/acl/authmethod/delete"
	aclamlist "github.com/opengyoza/opengyoza/command/acl/authmethod/list"
	aclamread "github.com/opengyoza/opengyoza/command/acl/authmethod/read"
	aclamupdate "github.com/opengyoza/opengyoza/command/acl/authmethod/update"
	aclbr "github.com/opengyoza/opengyoza/command/acl/bindingrule"
	aclbrcreate "github.com/opengyoza/opengyoza/command/acl/bindingrule/create"
	aclbrdelete "github.com/opengyoza/opengyoza/command/acl/bindingrule/delete"
	aclbrlist "github.com/opengyoza/opengyoza/command/acl/bindingrule/list"
	aclbrread "github.com/opengyoza/opengyoza/command/acl/bindingrule/read"
	aclbrupdate "github.com/opengyoza/opengyoza/command/acl/bindingrule/update"
	aclbootstrap "github.com/opengyoza/opengyoza/command/acl/bootstrap"
	aclpolicy "github.com/opengyoza/opengyoza/command/acl/policy"
	aclpcreate "github.com/opengyoza/opengyoza/command/acl/policy/create"
	aclpdelete "github.com/opengyoza/opengyoza/command/acl/policy/delete"
	aclplist "github.com/opengyoza/opengyoza/command/acl/policy/list"
	aclpread "github.com/opengyoza/opengyoza/command/acl/policy/read"
	aclpupdate "github.com/opengyoza/opengyoza/command/acl/policy/update"
	aclrole "github.com/opengyoza/opengyoza/command/acl/role"
	aclrcreate "github.com/opengyoza/opengyoza/command/acl/role/create"
	aclrdelete "github.com/opengyoza/opengyoza/command/acl/role/delete"
	aclrlist "github.com/opengyoza/opengyoza/command/acl/role/list"
	aclrread "github.com/opengyoza/opengyoza/command/acl/role/read"
	aclrupdate "github.com/opengyoza/opengyoza/command/acl/role/update"
	aclrules "github.com/opengyoza/opengyoza/command/acl/rules"
	acltoken "github.com/opengyoza/opengyoza/command/acl/token"
	acltclone "github.com/opengyoza/opengyoza/command/acl/token/clone"
	acltcreate "github.com/opengyoza/opengyoza/command/acl/token/create"
	acltdelete "github.com/opengyoza/opengyoza/command/acl/token/delete"
	acltlist "github.com/opengyoza/opengyoza/command/acl/token/list"
	acltread "github.com/opengyoza/opengyoza/command/acl/token/read"
	acltupdate "github.com/opengyoza/opengyoza/command/acl/token/update"
	"github.com/opengyoza/opengyoza/command/agent"
	"github.com/opengyoza/opengyoza/command/catalog"
	catlistdc "github.com/opengyoza/opengyoza/command/catalog/list/dc"
	catlistnodes "github.com/opengyoza/opengyoza/command/catalog/list/nodes"
	catlistsvc "github.com/opengyoza/opengyoza/command/catalog/list/services"
	"github.com/opengyoza/opengyoza/command/config"
	configdelete "github.com/opengyoza/opengyoza/command/config/delete"
	configlist "github.com/opengyoza/opengyoza/command/config/list"
	configread "github.com/opengyoza/opengyoza/command/config/read"
	configwrite "github.com/opengyoza/opengyoza/command/config/write"
	"github.com/opengyoza/opengyoza/command/connect"
	"github.com/opengyoza/opengyoza/command/connect/ca"
	caget "github.com/opengyoza/opengyoza/command/connect/ca/get"
	caset "github.com/opengyoza/opengyoza/command/connect/ca/set"
	"github.com/opengyoza/opengyoza/command/connect/envoy"
	"github.com/opengyoza/opengyoza/command/connect/envoy/pipe-bootstrap"
	"github.com/opengyoza/opengyoza/command/connect/proxy"
	"github.com/opengyoza/opengyoza/command/debug"
	"github.com/opengyoza/opengyoza/command/event"
	"github.com/opengyoza/opengyoza/command/exec"
	"github.com/opengyoza/opengyoza/command/forceleave"
	"github.com/opengyoza/opengyoza/command/info"
	"github.com/opengyoza/opengyoza/command/intention"
	ixncheck "github.com/opengyoza/opengyoza/command/intention/check"
	ixncreate "github.com/opengyoza/opengyoza/command/intention/create"
	ixndelete "github.com/opengyoza/opengyoza/command/intention/delete"
	ixnget "github.com/opengyoza/opengyoza/command/intention/get"
	ixnmatch "github.com/opengyoza/opengyoza/command/intention/match"
	"github.com/opengyoza/opengyoza/command/join"
	"github.com/opengyoza/opengyoza/command/keygen"
	"github.com/opengyoza/opengyoza/command/keyring"
	"github.com/opengyoza/opengyoza/command/kv"
	kvdel "github.com/opengyoza/opengyoza/command/kv/del"
	kvexp "github.com/opengyoza/opengyoza/command/kv/exp"
	kvget "github.com/opengyoza/opengyoza/command/kv/get"
	kvimp "github.com/opengyoza/opengyoza/command/kv/imp"
	kvput "github.com/opengyoza/opengyoza/command/kv/put"
	"github.com/opengyoza/opengyoza/command/leave"
	"github.com/opengyoza/opengyoza/command/lock"
	login "github.com/opengyoza/opengyoza/command/login"
	logout "github.com/opengyoza/opengyoza/command/logout"
	"github.com/opengyoza/opengyoza/command/maint"
	"github.com/opengyoza/opengyoza/command/members"
	"github.com/opengyoza/opengyoza/command/monitor"
	"github.com/opengyoza/opengyoza/command/operator"
	operauto "github.com/opengyoza/opengyoza/command/operator/autopilot"
	operautoget "github.com/opengyoza/opengyoza/command/operator/autopilot/get"
	operautoset "github.com/opengyoza/opengyoza/command/operator/autopilot/set"
	operraft "github.com/opengyoza/opengyoza/command/operator/raft"
	operraftlist "github.com/opengyoza/opengyoza/command/operator/raft/listpeers"
	operraftremove "github.com/opengyoza/opengyoza/command/operator/raft/removepeer"
	"github.com/opengyoza/opengyoza/command/reload"
	"github.com/opengyoza/opengyoza/command/rtt"
	"github.com/opengyoza/opengyoza/command/services"
	svcsderegister "github.com/opengyoza/opengyoza/command/services/deregister"
	svcsregister "github.com/opengyoza/opengyoza/command/services/register"
	"github.com/opengyoza/opengyoza/command/snapshot"
	snapinspect "github.com/opengyoza/opengyoza/command/snapshot/inspect"
	snaprestore "github.com/opengyoza/opengyoza/command/snapshot/restore"
	snapsave "github.com/opengyoza/opengyoza/command/snapshot/save"
	"github.com/opengyoza/opengyoza/command/tls"
	tlsca "github.com/opengyoza/opengyoza/command/tls/ca"
	tlscacreate "github.com/opengyoza/opengyoza/command/tls/ca/create"
	tlscert "github.com/opengyoza/opengyoza/command/tls/cert"
	tlscertcreate "github.com/opengyoza/opengyoza/command/tls/cert/create"
	"github.com/opengyoza/opengyoza/command/validate"
	"github.com/opengyoza/opengyoza/command/version"
	"github.com/opengyoza/opengyoza/command/watch"
	consulversion "github.com/opengyoza/opengyoza/version"
